...
class SettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "delivery_time_cost" => "required|numeric",
    ...
    public function message(){
        return [
            ...
            "delivery_time_cost.required" => __('validation.required', ['attribute' => 'delivery_time Cost']),
            "delivery_time_cost.numeric" => __('validation.numeric', ['attribute' => 'delivery_time Cost']),
