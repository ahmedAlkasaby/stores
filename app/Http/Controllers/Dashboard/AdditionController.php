...
class AdditionController extends MainController
{
    ...
    {
        if ($addition->products()->count() > 0) {
            return redirect()->route('dashboard.additions.index')->with('error', __('site.addition_cant_be_deleted'));
        }
    ...
    public function toggleActive(Addition $addition)
    {
