...
@section('content')
    ...
    @include('admin.categories.includes.filter')
...
@section('jsFiles')
    ...
    @include('admin.layouts.table.dataTableJs', ['table' => $categories->count() > 0])
    @include('admin.layouts.table.ajaxActiveJs', ['model' => 'categories'])
@endsection
@endsection
