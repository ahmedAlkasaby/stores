...
@section('content')
    ...
    <div class="card">
        @include('admin.sliders.includes.table')
    </div>
    </div>
...
@section('jsFiles')
    ...
    @include('admin.layouts.table.dataTableJs', ['table' => $sliders->count() > 0])
    @include('admin.layouts.table.ajaxActiveJs', ['model' => 'sliders'])
@endsection
@endsection
